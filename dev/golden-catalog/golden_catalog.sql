...
INSERT INTO golden_seed VALUES
 ...
 ('decimal_key','garbage','postgres','ext.decimal_key','dkey','decimal(15,0)',150000,'1','150000',1.0,'full',NULL,NULL,NULL,NULL,'scale-0 DECIMAL PK (ERP-migration shape): NOT integer-family -> keyset REJECTS it LOUDLY at plan time (the cursor cannot advance past a decimal), an explicit range chunk_column also bails (#103), so init picks mode:full','dev/garbage/postgres.sql'),
 ...
 ('decimal_key','garbage','mysql','ext_decimal_key','dkey','decimal(15,0)',150000,'1','150000',1.0,'full',NULL,NULL,NULL,NULL,'scale-0 DECIMAL PK (ERP-migration shape): NOT integer-family -> keyset REJECTS it LOUDLY at plan time (the cursor cannot advance past a decimal), an explicit range chunk_column also bails (#103), so init picks mode:full','dev/garbage/mysql.sql'),
 ...
 ('decimal_key','garbage','mssql','ext.decimal_key','dkey','decimal(15,0)',150000,'1','150000',1.0,'full',NULL,NULL,NULL,NULL,'scale-0 DECIMAL PK (ERP-migration shape): NOT integer-family -> keyset REJECTS it LOUDLY at plan time (the cursor cannot advance past a decimal), an explicit range chunk_column also bails (#103), so init picks mode:full','dev/garbage/mssql.sql'),
