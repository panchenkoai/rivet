...
#   GITHUB_REPOSITORY=owner/rivet ./dev/scripts/update_homebrew_formula.sh
#   ./dev/scripts/update_homebrew_formula.sh --tag v0.2.0-beta.1   # override tag (version still from tag)
#   ./dev/scripts/update_homebrew_formula.sh --tag v0.2.0-beta.1 --sums-file artifacts/SHA256SUMS.txt  # CI (no curl)
#
