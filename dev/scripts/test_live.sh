...
#
# Usage:
#   ./dev/scripts/test_live.sh                      # run all live tests (postgres + mysql)
#   ./dev/scripts/test_live.sh pg                   # run only postgres live tests
#   ./dev/scripts/test_live.sh mysql                # run only mysql live tests
#   ./dev/scripts/test_live.sh filter <pattern>     # run tests matching pattern
#
